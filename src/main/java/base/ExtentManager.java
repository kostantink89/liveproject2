...
public class ExtentManager extends BasePage {
	...
	public static ThreadLocal<ExtentTest> extentText = new ThreadLocal<>();
	...
	public static String extentReportsPrefix_Name(String testName) {
		String date = new SimpleDateFormat("yyyy-MM-dd_HH-mm_ss").format(new Date());
